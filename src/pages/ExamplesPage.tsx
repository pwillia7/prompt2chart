...
export function ExamplesPage() {
  useDocumentTitle('Chart Gallery - Prompt2Chart')
      ...
      <section className="py-14 sm:py-18">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-4 text-lg text-[var(--text-muted)] max-w-2xl mx-auto">
            Every chart below was generated by AI from a natural language prompt.
            These are the same rendering engines your charts use.
          </p>
        </div>
      </section>
