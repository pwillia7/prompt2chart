      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-5">
        ...
        <div className="flex gap-8 items-start">
          ...
          <div className="flex-1 min-w-0 space-y-5">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex items-center gap-2">
                <div ref={exportMenuRef} className="relative">
                  ...
                  {exportOpen && (
                    <div className="absolute left-0 mt-1 w-44 bg-[var(--surface-1)] rounded-card border border-[var(--border)] shadow-medium z-50 py-1">
                  ...
                  {exportToast && (
                    <div className="absolute left-0 mt-2 px-3 py-2 bg-[var(--surface-1)] text-[var(--text)] text-sm rounded-card shadow-medium border border-[var(--border)] whitespace-nowrap z-50">
                      {exportToast}
                    </div>
                  )}
                </div>
            ...
            {/* Single-prompt callout — only when no history and project name is set */}
            {!hasHistory && shared.project_name && (
              <div className="flex items-start gap-3 border-l-2 border-[var(--primary)] bg-[var(--surface-2)] rounded-r-card pl-4 pr-4 py-3">
          ...
          {hasHistory && (
            <aside className="w-52 shrink-0 hidden lg:block sticky top-6 bg-[var(--surface-1)] rounded-card border border-[var(--border)] p-4">
              <p className="text-xs font-medium text-[var(--text-subtle)] uppercase tracking-wider mb-3">Chart history</p>
                    ...
                    <li key={i} className="flex gap-2.5">
                      ...
                      <div className="flex flex-col items-center">
                        <div className={`w-2 h-2 rounded-full shrink-0 mt-1.5 ${
                          isCurrent ? 'bg-[var(--primary)]' : 'bg-[var(--border-strong)]'
                        }`} />
                        {!isCurrent && (
                          <div className="w-px flex-1 bg-[var(--border)] my-1" style={{ minHeight: '0.75rem' }} />
                        )}
                      </div>
                      {/* Step content */}
                      <div className={`flex-1 min-w-0 ${isCurrent ? 'pb-0' : 'pb-3'}`}>
